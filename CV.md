...
Toronto, Ontario, Canada &bull; [GitHub](https://github.com/willowell/) &bull; [LinkedIn](https://www.linkedin.com/in/williamphowell/)

## Full Stack Software Developer

Agile, user-oriented professional with over 3 years of experience working with beloved, wide-reaching Canadian brands. Loves learning, experimenting with, and staying up-to-date with computer technologies and best practices. Strives to deliver an accessible, superior user experience (UX) and developer experience (DX). Designs solutions with a test-driven, domain-driven, and functional- and immutable-first approach, focusing on pragmatic solutions that deliver value to users.
